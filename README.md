...
Она создаёт временную сессию только после этих проверок, удерживает её до
нажатия `Ctrl-C` и затем закрывает. Сейчас команда запускает программный слой
захвата; управление им из TUI появится на этапе 7.
